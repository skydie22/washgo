            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->is('admin/booking-order') ? 'active' : '' }} ">
                            <a href="{{ url('/admin/booking-order') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i> <span>Booking Order</span>
                            </a>
                        </li>

                        <li class="sidebar-item  {{ request()->is('admin/schedule') ? 'active' : '' }}">
                            <a href="{{ url('admin/schedule') }}" class='sidebar-link'>
                                <i class="bi bi-clock-fill"></i> <span>Schedule</span>
                            </a>
                        </li>
